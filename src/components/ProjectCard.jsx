...
const ProjectCard = ({
  applogo, title, description, demo, github, techarray, created, updated,
}) => {
  ...
  return (
    <div>
      <Card
        style={{ width: '18rem', marginBottom: '3rem', height: isAccordionOpen ? 'auto' : '550px' }}
        border="warning"
      >
        ...
        <Card.Footer bg="dark">
          <Stack direction="horizontal" gap={3}>
            ...
            <small className="text-muted" style={{ fontSize: '9px', fontWeight: 'bold' }}>
              Created:
              {' '}
              {created}
            </small>
